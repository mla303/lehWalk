...
class PsColors {
  ...
  /// Common Theme
  ///
  static const Color _c_main_color = Color(0xFFf12b2b);
  static const Color _c_main_light_color = Color(0xFFf45453);
  static const Color _c_main_dark_color = Color(0xFFbe0808);
