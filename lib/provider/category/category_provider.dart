...
class CategoryProvider extends PsProvider {
  ...
  Future<dynamic> loadCategoryList(String cityId) async {
    isLoading = true;

    isConnectedToInternet = await Utils.checkInternetConnectivity();

    await _repo.getCategoryList(categoryListStream, isConnectedToInternet,
        limit, offset, PsStatus.PROGRESS_LOADING, cityId);
  }

  Future<dynamic> nextCategoryList(String cityId) async {
    isConnectedToInternet = await Utils.checkInternetConnectivity();
  ...
  Future<void> resetCategoryList(String cityId) async {
    isConnectedToInternet = await Utils.checkInternetConnectivity();
    isLoading = true;
